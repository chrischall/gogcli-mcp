...
Extended Google Docs [MCP](https://modelcontextprotocol.io) server via [gogcli](https://github.com/openclaw/gogcli). Includes auth tools plus 14 additional dedicated Docs tools for editing, exporting, comments, and more.
