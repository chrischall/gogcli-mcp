...
describe('gog_drive_upload', () => {
  ...
  it('passes all upload flags', async () => {
    await harness.callTool('gog_drive_upload', {
      localPath: '/tmp/x.txt',
      name: 'renamed.txt',
      parent: 'folder1',
      replace: 'file2',
...
describe('gog_drive_drives_list', () => {
  it('calls runOrDiagnose with no flags', async () => {
    await harness.callTool('gog_drive_drives_list', {});
    expect(lib.runOrDiagnose).toHaveBeenCalledWith(['drive', 'drives'], { account: undefined });
  });

  it('passes all listing flags', async () => {
    await harness.callTool('gog_drive_drives_list', { max: 50, page: 'tok', all: true, query: 'engineering' });
    expect(lib.runOrDiagnose).toHaveBeenCalledWith(
  ...
  it('omits --all when false', async () => {
    await harness.callTool('gog_drive_drives_list', { all: false });
    expect(lib.runOrDiagnose).toHaveBeenCalledWith(['drive', 'drives'], { account: undefined });
  });
});
...
describe('gog_drive_comments_list', () => {
  ...
  it('includes --since, --include-quoted and pagination flags when set', async () => {
    await harness.callTool('gog_drive_comments_list', {
...
describe('gog_drive_comments_reply', () => {
  ...
  it('passes --action=resolve when action provided', async () => {
    await harness.callTool('gog_drive_comments_reply', {
...
describe('gog_drive_du', () => {
  it('calls runOrDiagnose with no flags', async () => {
    await harness.callTool('gog_drive_du', {});
  ...
  it('handles depth/max=0 and omits noAllDrives when false', async () => {
    await harness.callTool('gog_drive_du', { depth: 0, max: 0, noAllDrives: false });
    expect(lib.runOrDiagnose).toHaveBeenCalledWith(
...
describe('gog_drive_tree', () => {
  it('calls runOrDiagnose with no flags', async () => {
    await harness.callTool('gog_drive_tree', {});
    expect(lib.runOrDiagnose).toHaveBeenCalledWith(['drive', 'tree'], { account: undefined });
  });

  it('passes all flags', async () => {
    await harness.callTool('gog_drive_tree', { parent: 'folder1', depth: 4, max: 100, noAllDrives: true });
    expect(lib.runOrDiagnose).toHaveBeenCalledWith(
  ...
  it('handles depth=0 and omits noAllDrives when false', async () => {
    await harness.callTool('gog_drive_tree', { depth: 0, noAllDrives: false });
...
describe('gog_drive_changes_start_token', () => {
  it('calls runOrDiagnose with no flags', async () => {
    await harness.callTool('gog_drive_changes_start_token', {});
  ...
  it('passes --drive when provided', async () => {
    await harness.callTool('gog_drive_changes_start_token', { drive: 'd1', account: 'a@b.com' });
    expect(lib.runOrDiagnose).toHaveBeenCalledWith(
...
describe('gog_drive_changes_list', () => {
  it('calls runOrDiagnose with token only', async () => {
    await harness.callTool('gog_drive_changes_list', { token: 'tok1' });
    expect(lib.runOrDiagnose).toHaveBeenCalledWith(
  ...
  it('passes all flags', async () => {
    await harness.callTool('gog_drive_changes_list', {
  ...
  it('omits boolean flags when false', async () => {
    await harness.callTool('gog_drive_changes_list', { token: 'tok1', all: false, includeRemoved: false });
    expect(lib.runOrDiagnose).toHaveBeenCalledWith(
      ['drive', 'changes', 'list', '--token=tok1'],
      { account: undefined },
    );
...
describe('gog_drive_labels_list', () => {
  it('calls runOrDiagnose with no flags', async () => {
    await harness.callTool('gog_drive_labels_list', {});
...
describe('gog_drive_labels_get', () => {
  ...
  it('passes all flags', async () => {
    await harness.callTool('gog_drive_labels_get', {
...
describe('gog_drive_labels_file_apply', () => {
  ...
  it('passes all repeatable field flags and fields-json', async () => {
    await harness.callTool('gog_drive_labels_file_apply', {
      fileId: 'f1',
      labelId: 'l1',
...
describe('gog_drive_activity', () => {
  it('calls runOrDiagnose with no flags', async () => {
    await harness.callTool('gog_drive_activity', {});
  ...
  it('omits boolean flags when false', async () => {
    await harness.callTool('gog_drive_activity', { all: false, consolidate: false });
    expect(lib.runOrDiagnose).toHaveBeenCalledWith(['drive', 'activity', 'query'], { account: undefined });
  });
});
...
describe('gog_drive_audit_sharing', () => {
  it('calls runOrDiagnose with no flags', async () => {
    await harness.callTool('gog_drive_audit_sharing', {});
...
describe('gog_drive_audit_user', () => {
  ...
  it('passes all flags', async () => {
    await harness.callTool('gog_drive_audit_user', {
