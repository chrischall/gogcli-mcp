...
Monorepo of MCP servers wrapping [gogcli](https://github.com/openclaw/gogcli) — gives Codex read/write access to Google Workspace (Sheets, Docs, Gmail, Calendar, Drive, Slides, Classroom, Tasks, Contacts). Each package is a standalone MCP server using stdio transport.
