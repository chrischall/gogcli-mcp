...
|---------|------|-------------|
| `gogcli-mcp` | `packages/gogcli-mcp` | Base — all 59 tools (auth, gmail, calendar, drive, tasks, contacts, basic sheets/docs) |
...
| `gogcli-mcp-docs` | `packages/gogcli-mcp-docs` | Standalone — base + 8 extra Docs tools (insert, delete, export, sed, tabs, etc.) |
